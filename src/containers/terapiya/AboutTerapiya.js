...
function AboutTerapiya({ setShow }) {
  ...
  const feedback_therapy =[
    {
        name:"Элина",
        text:"приходила на прием к терапевту МЦ Айдарова: врач ответила на все интересующие вопросы, была деликатна и очень доброжелательна. Назначила качественное лечение.",
    },
    {
        name:"Исмоилжон",
        text:"приходил на осмотр к терапевту Шагановой Ольге Александровне: хочу сказать спасибо, записался и попал на прием в один день, очень этому рад, хотел пройти обследование для себя, т.к. в праздники есть свободное время. Врач назначила необходимые анализы, приду по их готовности. Очень вам благодарен.",
    },
    {
        name:"Бакыт",
        text:"Наблюдаюсь у терапевта: доктор хорошо относится к пациентам, с ним приятно общаться. Все доступно объясняет. Принимает всегда без задержек и в назначенное время. Лечение назначает правильное, есть положительный результат.",
    },
    {
        name:"Аяна",
        text:"Приходила на приеме у терапевта в клинике Айдарова: грамотный специалист. Углубленно подходит к проблеме. Я осталась довольна. Персонал вежливый, доброжелательный. Всегда советую Вашу клинику знакомым. Удачи и процветания вам. Спасибо.",
    },
    {
        name:"Нурзат",
        text:"Была на приеме у терапевта в клинике Айдарова, так как моя подруга давно ходит сюда. А мне доктор нравится, как специалист, и как человек. Препараты подбирает разумно, все продумывает и анализирует. Мне нравится, что она не уходит от ответов. Открыто общается с пациентом, отвечает на все вопросы. Меня все устраивает. Спасибо Вам.",
    },
  ...
  return (
    <div className='terapiya' style={{ width: "100%" }}>
       <Navbar bg="dark" expand="lg" variant='dark'>
          <Container>
            <Navbar.Brand href="/"><img style={{ width: '50px', height: '50px', borderRadius: '50%' }} src={ter} /></Navbar.Brand>
      ...
      <div className=' terapiya5'>
        ...
        <Container>
          ...
          <Row className="justify-content-center mt-5">
                ...
                <Carousel >
                        {feedback_therapy.map(e => {
                                return (
                                    <Carousel.Item >
                                        <div className='feedback_therapy'>
                                        <h4>{e.name}</h4>
                                       <p>
                                           {e.text}
                                       </p>
